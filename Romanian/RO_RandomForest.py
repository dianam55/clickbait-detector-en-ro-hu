...
df_Clickbait_and_NonClickbait['Headline'] = df_Clickbait_and_NonClickbait['Headline'].astype(str).fillna('')
...
train_df['has_hyperbole'] = train_df['Headline'].str.contains('șocant|incredibil|uimitor', case=False).astype(int)
...
test_df['has_hyperbole'] = test_df['Headline'].str.contains('șocant|incredibil|uimitor', case=False).astype(int)
